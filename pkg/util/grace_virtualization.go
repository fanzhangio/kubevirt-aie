...
// All packages that need to inspect this annotation should use this
// struct and one of the Parse/Get helpers below.
...
// Returns nil when the annotation is absent, empty, or unparseable.
// Runtime code should use this lenient variant so that a transient parse
// error does not crash the virt-launcher.
...
// GraceFieldEnabled is a nil-safe helper: returns true only when the
// pointer is non-nil and the value is true.
