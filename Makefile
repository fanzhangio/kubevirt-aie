...
rpm-deps:
	SYNC_VENDOR=true hack/dockerized "ARCH_OVERRIDES=${ARCH_OVERRIDES} CUSTOM_REPO=${CUSTOM_REPO} SINGLE_ARCH=${SINGLE_ARCH} BASESYSTEM=${BASESYSTEM} LIBVIRT_VERSION=${LIBVIRT_VERSION} LIBVIRT_VERSION_AARCH64=${LIBVIRT_VERSION_AARCH64} QEMU_VERSION=${QEMU_VERSION} QEMU_VERSION_AARCH64=${QEMU_VERSION_AARCH64} QEMU_LAYOUT_AARCH64=${QEMU_LAYOUT_AARCH64} QEMU_BUNDLE_VERSION_AARCH64=${QEMU_BUNDLE_VERSION_AARCH64} SEABIOS_VERSION=${SEABIOS_VERSION} EDK2_VERSION=${EDK2_VERSION} LIBGUESTFS_VERSION=${LIBGUESTFS_VERSION} GUESTFSTOOLS_VERSION=${GUESTFSTOOLS_VERSION} PASST_VERSION=${PASST_VERSION} VIRTIOFSD_VERSION=${VIRTIOFSD_VERSION} SWTPM_VERSION=${SWTPM_VERSION} ./hack/rpm-deps.sh"
